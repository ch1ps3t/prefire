	...
	<div class="max-w-6xl mx-auto px-8 py-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			...
			<div class="space-y-6 text-center md:text-left lg:text-left">
				<h5 class="text-xl capitalize tracking-wider text-gray-400">Docs</h5>
				<ul class="space-y-2 text-md transition-duration-300 md:text-left">
					<li>
						<a href="/docs/#twitch" class="text-gray-500 hover:text-white transition-colors"
							>Setup</a
						>
					</li>
					<li>
					...
					<li>
						<a href="/docs/#admin-panel" class="text-gray-500 hover:text-white transition-colors"
							>Admin panel</a
						>
					</li>
				</ul>
			...
			<!-- Service -->
			<div class="space-y-6 text-center md:text-left lg:text-left">
				<h5 class="text-xl capitalize tracking-wider text-gray-400">Service</h5>
				<ul class="space-y-2 text-md transition-duration-300 text-center md:text-left lg:text-left">
					<li>
						<a
							href="https://app.prefire.gg/login"
							class="text-gray-500 hover:text-white transition-colors">Sign in</a
						>
					</li>
					<li>
						<a
							...
							class="text-gray-500 hover:text-white transition-colors">Pricing</a
						>
					</li>
					<li>
						<a
							href="/#faq"
							onclick={smoothScrollIfHome}
							class="text-gray-500 hover:text-white transition-colors">FAQ</a
						>
					</li>
					<li>
						<a href="/tournaments" class="text-gray-500 hover:text-white transition-colors"
							>Tournaments</a
						>
					</li>
				</ul>
			...
			<!-- Company -->
			<div class="space-y-6 text-center md:text-left lg:text-left">
				<h5 class="text-xl capitalize tracking-wider text-gray-400">Company</h5>
				<ul class="space-y-2 text-md transition-duration-300 md:text-left">
					<li>
						<a
							href="/company/#partnering"
							onclick={smoothScrollIfHome}
							class="text-gray-500 hover:text-white transition-colors">Partnering</a
						>
					</li>
					<li>
						<a
							...
							onclick={smoothScrollIfHome}
							class="text-gray-500 hover:text-white transition-colors">Contact</a
						>
					</li>
					<li>
						<a href="/policies/#privacy" class="text-gray-500 hover:text-white transition-colors"
							>Privacy Policy</a
						>
					</li>
				</ul>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			<p class="md:col-span-2 text-sm text-gray-500 leading-relaxed">
		...
		<div
			class="mt-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500"
		>
			...
			<div class="order-1 sm:order-2 flex items-center gap-6">
				...
				<a href="/policies/#condictions" class="hover:text-white transition-colors"
					>Terms of Service</a
				>
			</div>
		</div>
