		...
		<div class="flex items-center h-16">
			...
			<div class="hidden sm:flex sm:flex-grow sm:justify-end sm:space-x-6">
				<a
					...
					class="inline-flex transition-all duration-300 items-center px-1 pt-1 text-md text-center md:text-left font-medium text-gray-400 hover:text-white"
					>Skins</a
				>
				<a
					href="/#servers"
					onclick={smoothScrollIfHome}
					class="inline-flex transition-all duration-300 items-center px-1 pt-1 text-md font-medium text-gray-400 hover:text-white"
					>Servers</a
				>
				<a
					href="/#faq"
			...
			<div id="mobile-menu" class="sm:hidden pb-4 px-0">
				<div class="pt-2 space-y-1 text-center">
					<a
						href="/#skins"
						onclick={smoothScrollIfHome}
						class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:bg-gray-800"
						>Skins</a
					>
					<a
						href="/#servers"
